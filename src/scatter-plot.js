...
import { Agenttip } from './ui-agenttip.js';
...
export class ScatterPlot extends LitElement {
    ...
    updated() {
        ...
        this.agentsCol = this.shadowRoot.querySelector('#agentsCol');
    ...
    calculateDiagonalQuartiles(xValues, yValues){
        let agentsNotHidden = xValues.map((x, i) => [x, yValues[i]]);
        ...
        // Calculate the scores for each of the agent. based on their distance to the x and y axis
        let scores = [];

        // Object for store the scores and the coordinates of the agents
        let scoresCoords = {};
        ...
        for (let i = 0; i < xNorm.length; i++) {
            if (better == "bottom-right"){
                ...
                agentsNotHidden[i]['score'] = xNorm[i] + (1 - yNorm[i]);
            }
        ...
        // Get Annotations
        let annotationDiagonal = this.asigneQuartileDiagonal(agentsNotHidden, firstQuartile, secondQuartile, thirdQuartile, better);

        // Diagonal Q. Table
        this.createTableDiagonal(agentsNotHidden);
    ...
    createDataPointForTables (visibleAgents, groupedDataPoints, allAgentID) {
        ...
        allAgentID.forEach((agent) => {
            ...
            this.quartileDataArray.push({ agent_id: agent, cuartil: cuartil, label: label });
        })
    }

    asigneQuartileDiagonal(dataAgents, firstQuartile, secondQuartile, thirdQuartile, better) {
        let poly = [[],[],[],[]];
    ...
    createTableDiagonal(visibleAgent) {
        ...
        this.allAgentID.forEach((agent) => {
            ...
            this.quartileDataArray.push({ agent_id: agentName, cuartil: quartile, label: label });
        });
    }
        ...
        try {
            ...
            if(format === 'png') {
                if (this.viewSquare || this.viewKmeans || this.viewDiagonal) {
                    ...
                    const agentsCol = this.agentsCol;
                    agentsCol.classList.remove('responsive-table');
                    ...
                    agentsCol.classList.add('responsive-table');
                } else {
                ...
                if (this.viewSquare || this.viewKmeans || this.viewDiagonal) {
                    ...
                    const rows = this.quartileDataArray.map(q => [q.agent_id, q.label]);
                        ...
                        willDrawCell: function (data) {
                            if (data.row.section === 'body') {
                                ...
                                if (quartileValue === 1) {
                                    ...
                                    // Draw colored "div" in Agent column
                                    const rowIndex = data.row.index;
    ...
    setQuartilesVisibility() {
        ...
        if(plot && plot.length > 0) {
            ...
            this.calculateQuartiles(this.xValues, this.yValues, this.allAgentID);
            ...
            <div class="bar-plot oeb-graph">
                ...
                <div class="graph-row" id="todownload">
                    ...
                    ${ this.showAdditionalTable && this.sorted ? html`
                        <div class="col-4">
                            <div class="agents-col responsive-table" id="agentsCol">
                                <table class="agents-table responsive-table" id="benchmarkingTable">
                                    <thead>
                                        <tr>
